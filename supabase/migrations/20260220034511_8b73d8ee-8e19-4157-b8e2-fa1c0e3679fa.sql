...
CREATE OR REPLACE FUNCTION public.manage_client_cron(p_action text, p_client_slug text, p_client_id uuid DEFAULT NULL::uuid, p_interval_minutes integer DEFAULT 10)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
